...
function trial(file)
    ...
    df_General = DataFrame([[name], [round(sum(freq_actual)/ 0.2417990504024, digits=6)], [round(sum(ZPR), digits=6)], [round(sum(res_alpha), digits=6)], [round(sum(res_paper), digits=6)]], column_names)                
...
function trial_with_vw(file)
    ...
    df_General = DataFrame([[name], [round(sum(freq_actual)/ 0.2417990504024, digits=6)], [round(sum(ZPR), digits=6)], [round(sum(res_alpha), digits=6)], [round(sum(res_paper), digits=6)], [round(v, digits=6)], [round(w, digits=6)]], column_names)                
